...
$sql='SELECT (SELECT p.name FROM person as p WHERE p.id=od.person_id),od.person_id FROM orderDetail as od WHERE od.id='.$orderId.'';
    ...
    <div class="col-12 shadow card p-3">
        ...
        <?php
            ...
            else
            {
                ...
                echo '<a href="/Catering/order/orderEdit.php?order='.$orderId.'&option=PreviewOrder" class="text-center  mb-1  form-control btn-success">Order Preview</a>
';
            }
        ?>
