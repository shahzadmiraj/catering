...
<div class="container " style="margin-top:150px" >
    ...
    <form id="changeImage">
        ...
        <div class=" form-group row">
            ...
            else
            {
                ...
                ?> " style="height: 30vh" class="img-thumbnail figure-img" alt="image is not set">
        </div>
        <div class="form-group row">
    ...
    <form class="col-12 card shadow p-4 mb-3" id="authorchanging">
        ...
        <div class="form-group row">
            ...
            <input type="text" id="username" name="username" class="form-control col-8" value="<?php echo $userdetail[0][0];?>">
        </div>
        <div class="form-group row">
            <label for="password" class="col-form-label col-4">Password</label>
            <input type="text" id="password" name="password" class="form-control col-8" value="<?php echo $userdetail[0][1];?>">
        </div>
        <div class="form-group row">
            <label for="password1" class="col-form-label col-4">Confirm Password</label>
            <input type="text" id="password1" name="password1" class="form-control col-8" value="<?php echo $userdetail[0][1];?>">
        </div>
        <div class=" col-12">
...
p.id='.$customerId.'';
    ...
    <div class="form-group row mt-2">
        <button class="col-6 form-control btn btn-danger" id="Doneform">Done</button>
    </div>
</div>
