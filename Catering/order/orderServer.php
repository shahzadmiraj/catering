...
if($_POST['function']=="add")
{
    ...
    $sql='INSERT INTO `order`(`id`, `total_amount`, `order_comments`, `total_person`, `is_active`, `destination_date`, `booking_date`, `destination_time`, `address_id`, `extre_charges`, `person_id`) VALUES (NULL,0,"'.$describe.'",'.$persons.',1,"'.$date.'","'.$currentDate.'","'.$time.'",'.$address_id.',0,'.$customerId.')';
    querySend($sql);
