            ...
            <?php
                if(isset($_GET['option']))
                {
                    if($_GET['option']=="dishDisplay")
                    {
                        ...
                        echo '
            <a href="/customer/customerEdit.php?order='.$_GET['order'].'&customer='.$_GET['customer'].'&option=customerAndOrderalreadyHave"   id="cancel" class="form-control col-4 btn btn-danger"> Customer Edit</a>
            <a href="/dish/dishDisplay.php?order='.$_GET['order'].'"  id="submit" class="form-control col-4 btn-success"> Display Dish</a>';
                    }
                    else if($_GET['option']=="customerEdit")
                    {
                        ...
                        echo '
            <a href="/customer/customerEdit.php?order='.$_GET['order'].'&customer='.$_GET['customer'].'&option=customerAndOrderalreadyHave"   id="cancel" class="form-control col-4 btn btn-danger"> Customer Edit</a>
            <a href="/dish/dishDisplay.php?order='.$_GET['order'].'&option=orderEdit"  id="submit" class="form-control col-4 btn-success"> Display Dish</a>';
