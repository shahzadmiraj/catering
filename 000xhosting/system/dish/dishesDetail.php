...
<div class="container"  style="margin-top:180px">
    ...
    <div class="col-12 card shadow mb-2 p-4 ">
        <h3 align="center"> Dish information        <a  href="/system/dish/addDish.php" class=" btn-outline-primary btn form-control ">Add dish +</a>
        </h3>
        <div class="form-group row font-weight-bold border">
        ...
        for($i=0;$i<count($Dishes);$i++)
        {
            ...
            <a href="/system/dish/EditDish.php?dishid='.$Dishes[$i][1].'" class="col-4  form-control btn ';
